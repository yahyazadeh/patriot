...
def scheduleCheck() {
    ...
    def message = message1 ? message1 : 'SmartThings - Habit Helper Reminder!'
    if ( location .contactBookEnabled) {
        ...
        parent.verify(app.getLabel(), null, null, 'sending_sms', phone1 ) == true ? sendSms(phone1, message) : log.debug('Invariants Violation!')
    }
}
