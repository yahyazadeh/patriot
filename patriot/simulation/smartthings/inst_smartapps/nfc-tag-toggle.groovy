...
def touchHandler(evt) {
    ...
    if ( switch1 ) {
        ...
        switch1.each({ 
            if ( status == 'on') {
                parent.verify(app.getLabel(), evt , it.getDisplayName(), 'off', null) == true ? parent.verify(app.getLabel(), evt , it.getDisplayName(), 'off', null) == true ? parent.verify(app.getLabel(), evt , it.getDisplayName(), 'off', null) == true ? it.off() : log.debug('Invariants Violation!') : log.debug('Invariants Violation!') : log.debug('Invariants Violation!')
            } else {
                parent.verify(app.getLabel(), evt , it.getDisplayName(), 'on', null) == true ? parent.verify(app.getLabel(), evt , it.getDisplayName(), 'on', null) == true ? parent.verify(app.getLabel(), evt , it.getDisplayName(), 'on', null) == true ? it.on() : log.debug('Invariants Violation!') : log.debug('Invariants Violation!') : log.debug('Invariants Violation!')
            }
        })
    }
    if ( lock ) {
        ...
        lock.each({ 
            if ( status == 'locked') {
                parent.verify(app.getLabel(), evt , lock.getDisplayName(), 'unlocked', null) == true ? parent.verify(app.getLabel(), evt , lock.getDisplayName(), 'unlocked', null) == true ? parent.verify(app.getLabel(), evt , lock.getDisplayName(), 'unlocked', null) == true ? lock.unlock() : log.debug('Invariants Violation!') : log.debug('Invariants Violation!') : log.debug('Invariants Violation!')
            } else {
                parent.verify(app.getLabel(), evt , lock.getDisplayName(), 'locked', null) == true ? parent.verify(app.getLabel(), evt , lock.getDisplayName(), 'locked', null) == true ? parent.verify(app.getLabel(), evt , lock.getDisplayName(), 'locked', null) == true ? lock.lock() : log.debug('Invariants Violation!') : log.debug('Invariants Violation!') : log.debug('Invariants Violation!')
            }
        })
    }
    if ( garageDoor ) {
        ...
        garageDoor.each({ 
            if ( status == 'open') {
                parent.verify(app.getLabel(), evt , it.getDisplayName(), 'closed', null) == true ? parent.verify(app.getLabel(), evt , it.getDisplayName(), 'closed', null) == true ? parent.verify(app.getLabel(), evt , it.getDisplayName(), 'closed', null) == true ? it.close() : log.debug('Invariants Violation!') : log.debug('Invariants Violation!') : log.debug('Invariants Violation!')
            } else {
                parent.verify(app.getLabel(), evt , it.getDisplayName(), 'open', null) == true ? parent.verify(app.getLabel(), evt , it.getDisplayName(), 'open', null) == true ? parent.verify(app.getLabel(), evt , it.getDisplayName(), 'open', null) == true ? it.open() : log.debug('Invariants Violation!') : log.debug('Invariants Violation!') : log.debug('Invariants Violation!')
            }
        })
    }
}
