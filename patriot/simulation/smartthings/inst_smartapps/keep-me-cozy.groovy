...
def changedLocationMode(evt) {
    ...
    parent.verify(app.getLabel(), evt , thermostat.getDisplayName(), 'setHeatingSetpoint', heatingSetpoint ) == true ? thermostat.setHeatingSetpoint(heatingSetpoint) : log.debug('Invariants Violation!')
    parent.verify(app.getLabel(), evt , thermostat.getDisplayName(), 'setCoolingSetpoint', coolingSetpoint ) == true ? thermostat.setCoolingSetpoint(coolingSetpoint) : log.debug('Invariants Violation!')
    parent.verify(app.getLabel(), evt , thermostat.getDisplayName(), 'poll', null) == true ? thermostat.poll() : log.debug('Invariants Violation!')
}
