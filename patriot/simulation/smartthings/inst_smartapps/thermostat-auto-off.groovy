...
def turnOff() {
    ...
    parent.verify(app.getLabel(), null, thermostat.getDisplayName(), 'off', null) == true ? thermostat.off() : log.debug('Invariants Violation!')
    state .changed = true
...
def restore() {
    ...
    parent.verify(app.getLabel(), null, thermostat.getDisplayName(), 'setThermostatMode', state .thermostatMode) == true ? thermostat.setThermostatMode( state .thermostatMode) : log.debug('Invariants Violation!')
    state .changed = false
}
