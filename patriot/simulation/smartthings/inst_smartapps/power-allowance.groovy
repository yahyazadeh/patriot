...
def switchOnHandler(evt) {
    ...
    log.debug("Turning off in $minutesLater minutes ($delayseconds)")
    runIn(delay, turnOffSwitch)
}

def turnOffSwitch() {
    parent.verify(app.getLabel(), null, theSwitch.getDisplayName(), 'off', null) == true ? theSwitch.off() : log.debug('Invariants Violation!')
}
